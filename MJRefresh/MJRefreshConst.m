...
NSString *const MJRefreshAutoFooterNoMoreDataText = @"Load Complete";
...
NSString *const MJRefreshBackFooterIdleText = @"Drag to Load More";
NSString *const MJRefreshBackFooterPullingText = @"Release";
NSString *const MJRefreshBackFooterRefreshingText = @"Loading...";
NSString *const MJRefreshBackFooterNoMoreDataText = @"Load Complete";
